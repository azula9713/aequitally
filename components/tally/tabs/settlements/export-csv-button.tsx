...
export default function ExportCSVButton({
  ...
  const handleExport = async (): Promise<void> => {
    ...
    try {
      ...
      const csvContent = csvExportService.generateSettlementCSV(tally, transfers);
  ...
  return (
    <Button
      ...
      className="gap-2"
      title={isExporting ? "Generating CSV..." : `Export settlement summary as CSV (${generateFilename()})`}
    >
      {isExporting ? (
